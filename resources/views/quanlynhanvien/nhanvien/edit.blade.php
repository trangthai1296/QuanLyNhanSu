                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <form action="{{route('nhanVienUpdate',['id'=>$nhanvien->id])}}" method="post">
                                    {{@csrf_field()}}
                                    ...
                                    <div class="form-group">
                                        <label for="tinhtrang" class=" form-control-label">Tình Trạng</label>
                                        <input type="text" class="form-control" name="tinhtrang" value="{{$nhanvien->tinhtrang}}">
                                    </div>
                                    <div class="form-group">
                                        <label for="hesoluong" class=" form-control-label">Hệ Số Lương</label>
                                        <input type="text" class="form-control" name="hesoluong" value="{{$nhanvien->hesoluong}}">
                                    </div>
                                    <div class="form-group">
                                        <label for="maphongban">Phòng Ban</label>
                                        <select type="text" class="form-control" name="maphongban" value="{{$nhanvien->maphongban}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select type="text" class="form-control" name="machucvu" value="{{$nhanvien->machucvu}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select type="text" class="form-control" name="madotphongvan"  value="{{$nhanvien->madotphongvan}}">

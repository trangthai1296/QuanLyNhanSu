                     ...
                     <div class="col-lg-12">
                         <div class="card">
                             ...
                             <div class="card-body card-block">
                                 <form action="{{route('dotPhongVanUpdate',['id'=>$dotphongvan->id])}}" method="post">
                                     {{@csrf_field()}}
                                     <div class="form-group">
                                         <label for="madottuyendung" class=" form-control-label">Đợt tuyển dụng</label>
                                         <input type="text" class="form-control" name="madottuyendung"
                                         value="{{$dotphongvan->dottuyendung}}">
                                     </div>
                                     <div class="form-group">
                                         <label for="ten" class=" form-control-label">Tên</label>
                                         <input type="text" class="form-control" name="ten"
                                         value="{{$dotphongvan->ten}}">
                                     </div>
                                     <div class="form-group">
                                         <label for="soluong" class=" form-control-label">Số lượng</label>
                                         <input type="number" class="form-control" name="soluong"
                                         value="{{$dotphongvan->soluong}}">
                                     </div>
                                     <div class="form-group">
                                         <label for="diadiem" class=" form-control-label">Địa điểm</label>
                                         <input type="text" class="form-control" name="diadiem"
                                         value="{{$dotphongvan->diadiem}}">
                                     </div>
                                     <div class="form-group">
                                         <label for="ngaybatdau" class=" form-control-label">Ngày bắt đầu</label>
                                         <input type="date" class="form-control" name="ngaybatdau"
                                         value="{{$dotphongvan->ngaybatdau}}">
                                     </div>
                                     <div class="form-group">
                                         <label for="ngayketthuc" class=" form-control-label">Ngày kết thúc</label>
                                         <input type="date" class="form-control" name="ngayketthuc"
                                         value="{{$dotphongvan->ngayketthuc}}">
                                     </div>

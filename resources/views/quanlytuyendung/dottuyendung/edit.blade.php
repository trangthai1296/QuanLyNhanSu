                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <form action="{{route('dotTuyenDungUpdate',['id'=>$dottuyendung->id])}}" method="post">
                                    {{@csrf_field()}}
                                    <div class="form-group">
                                        <label for="ten" class=" form-control-label">Tên</label>
                                        <input type="text" class="form-control" name="ten" value="{{$dottuyendung->ten}}">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="soluong" value="{{$dottuyendung->soluong}}">
                                    </div>
                                    <div class="form-group">
                                        <label for="ngaybatdau" class=" form-control-label">Ngày bắt đầu</label>
                                        <input type="date" class="form-control" name="ngaybatdau"  value="{{$dottuyendung->ngaybatdau}}">
                                    </div>
                                    <div class="form-group">
                                        <label for="ngayketthuc" class=" form-control-label">Ngày kết thúc</label>
                                        <input type="date" class="form-control" name="ngayketthuc"  value="{{$dottuyendung->ngayketthuc}}">
                                    </div>
